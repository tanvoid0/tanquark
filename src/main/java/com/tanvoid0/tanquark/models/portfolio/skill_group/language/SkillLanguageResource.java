...
@Path("/api/skill/language")
@RolesAllowed({"USER", "PORTFOLIO_USER"})
@RequiredArgsConstructor
public class SkillLanguageResource {
    ...
    public Response create(@RequestBody final NewSkillHardItemVO request) {
        final SkillLanguageVO skill = skillLanguageService.addSkill(request);
    ...
    public Response create(@RequestBody final List<NewSkillHardItemVO> request) {
        final List<SkillLanguageVO> skills = skillLanguageService.addSkill(request);
